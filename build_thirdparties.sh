...
gpac_flags="--enable-pic --disable-3d  --disable-x11 --use-xvid=no --disable-qjs --use-png=no --use-jpeg=no --disable-ogg --use-xvid=no --extra-libs=-sERROR_ON_UNDEFINED_SYMBOLS=0"
